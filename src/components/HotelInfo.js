...
const HotelInfo = () => {
  ...
  const loadAccessibilityData = async() => {
    ...
    const resp = await fetch('https://l6zau3579e.execute-api.us-east-1.amazonaws.com/Production/accessibilities');
  ...
  const loadServicesData = async() => {
    // Query the API Gateway
    const resp = await fetch('https://l6zau3579e.execute-api.us-east-1.amazonaws.com/Production/services');
    let jsonData = await resp.json();
